    ...
    <div class="admin-overview">
        ...
        <div class="bottom-grid">
            ...
            <div class="panel">
                ...
                <!-- Category cards grid -->
                <div class="cat-grid">
                    <div class="cat-card" v-for="cat in categoryStats" :key="cat.name"
                         :style="{ borderTopColor: cat.catColor }">
                        ...
                        <div class="cat-status-grid">
                            <div class="cat-status-item" v-for="seg in cat.segments" :key="seg.type"
                ...
                <div class="status-legend">
                    <div class="legend-item" v-for="s in statusLegend" :key="s.type">
...
export default {
    ...
    computed: {
        ...
        statCards() {
            ...
            return [
                { key: 'active',   value: active,   label: '已生效流程',   icon: 'fal fa-sitemap',       color: '#6e5faf', bg: '#f0eeff', trend: '較上月 +0',         trendDir: 'up'  },
                { key: 'total',    value: total,    label: '本月申請總量', icon: 'fal fa-file-alt',      color: '#f4a42c', bg: '#fff8ee', trend: '較上月 +3',         trendDir: 'up'  },
                { key: 'approved', value: approved, label: '本月核准件數', icon: 'fal fa-check-circle',  color: '#00a76f', bg: '#edfbf5', trend: `核准率 ${rate}%`,   trendDir: 'up'  },
                { key: 'pending',  value: pending,  label: '目前待審核數', icon: 'fal fa-hourglass-half',color: '#e05c5c', bg: '#fff0f0', trend: '需盡快處理',         trendDir: 'up'  },
            ];
        },
        categoryStats() {
            const groups = {};
...
.stat-card {
    ...
    .stat-body {
        flex: 1; min-width: 0;
        .stat-value { font-size: 28px; font-weight: 700; color: #333; line-height: 1.1; }
...
.cat-card {
    ...
    &:hover { box-shadow: 0 3px 12px rgba(72, 62, 114, 0.1); }
    ...
    .cat-status-item {
        ...
        &.is-zero {
            .csi-num  { color: #ddd !important; }
            .csi-label { color: #ddd; }
        }

        .csi-num {
            font-size: 20px; font-weight: 700;
            line-height: 1.1; color: #ccc;
        }
...
.activity-item {
    ...
    .activity-body {
        ...
        .activity-main {
            ...
            .activity-dept {
                font-size: 11px; color: #aaa;
                background: #f5f3fb; padding: 1px 6px; border-radius: 10px;
            }
        }
